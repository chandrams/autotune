...
num_workers=5
interval_hours=6
initial_end_date="2024-11-28T00:00:00.000Z"
...
echo ""
python3 bulk_stress_test.py --test ${test} --workers ${num_workers} --enddate ${initial_end_date} --interval ${interval_hours} --resultsdir ${LOG_DIR} | tee -a ${LOG}
